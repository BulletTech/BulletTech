...
有传言称Apple将在WWDC 2021上发布新的14英寸和16英寸MacBook Pro，新机型将有可能搭配下一代的M系列芯片、mini-LED显示屏、超过2个USB-C接口和全新的类似iPhone 12的方正设计，新的磁吸充电接口，并使用传统的功能键代替Touchbar。这些预测中新的芯片、显示屏，以及更多的接口成为现实的可能性较大。总得来说，前有M1 MacBook Air和13英寸MacBook Pro打下良好的口碑，新机型大概率在产品力上更上一层楼，如果有升级需求，上就完事了！
