...
至于扩展性，搭配M1芯片的Mac中，Mac mini的接口数量是最多、最全的之一（如下图所示）。最高支持同时连接一台6K (60Hz) 的显示器和一台4K (60Hz) 的显示器

<figure>
  <img src="https://cdn.jsdelivr.net/gh/BulletTech2021/Pics/2021-6-2/1622640979669-image.png" width="600" />
