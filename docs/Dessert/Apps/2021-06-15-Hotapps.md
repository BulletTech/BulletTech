...
Spark是我最喜欢的邮件客户端，由Readdle开发。其主要优点包括：用户界面清爽、功能布局合理、实用的智能收件箱、丰富的快捷键、灵活的收件箱规则和搜索、多平台同步迅速、支持多种第三方插件，个人版免费。这是一款看第一眼就让人接着用的产品。美中不足的是网易屏蔽了Spark
...
macOS上的PDF Expert是PDF软件的独一档，同样由Readdle开发。阅读、批注 PDF，编辑文本，添加照片，填写表单，签署合同
